CLASS zcl_jas_data_gen_ac DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_jas_data_gen_ac IMPLEMENTATION.
...
*last_changed_at       : abp_lastchange_tstmpl;
 ...
 data:    lt_acc_categ type table of ZJAS_TB_ACC_CAT,
          lt_catego    type table of ZJAS_TB_CAT,
          lt_clientes  type table of ZJAS_TB_CLIENTES,
          lt_clnts_lib type table of ZJAS_TB_CLNT_LIB,
          lt_libros    type table of ZJAS_TB_LIBROS.
...
******** ZJAS_TB_ACC_CAT ********
    ...
    delete from ZJAS_TB_ACC_CAT.
    insert ZJAS_TB_ACC_CAT from table @lt_acc_categ.
...
******** ZJAS_TB_CAT ********
    ...
    "Delete possible entries; insert new entries
    delete from ZJAS_TB_CAT.
    insert ZJAS_TB_CAT from table @lt_catego.
...
******** ZJAS_TB_CLIENTES ********
    ...
    "Delete possible entries; insert new entries
    delete from ZJAS_TB_CLIENTES.
    insert ZJAS_TB_CLIENTES from table @lt_clientes.
...
******** ZJAS_TB_CLNT_LIB
    ...
    "Delete possible entries; insert new entries
    delete from ZJAS_TB_CLNT_LIB.
    insert ZJAS_TB_CLNT_LIB from table @lt_clnts_lib.
...
******** ZJAS_TB_LIBROS ********
    ...
    'https://eltinteroeditorial.com/wp-content/uploads/2017/06/c%C3%B3mo-es-el-proceso-de-edici%C3%B3n.jpg' ) ).
    "Delete possible entries; insert new entries
    delete from ZJAS_TB_LIBROS.
    insert ZJAS_TB_LIBROS from table @lt_libros.
